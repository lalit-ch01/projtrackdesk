...
const columns = [
  {
    ...
    links: [
      ...
      { label: 'Rubrics', href: '/rubrics-feature' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Capstone', href: '/use-cases/capstone' },
      { label: 'Internships', href: '/use-cases/internships' },
      { label: 'Research Labs', href: '/use-cases/research' },
      ...
      { label: 'For HODs', href: '/services/hods' },
    ],
  },
  {
    title: 'Resources',
    links: [
      ...
      { label: 'Rubric Builder', href: '/tools/rubric-builder' },
